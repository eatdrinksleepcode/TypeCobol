...
namespace TypeCobol.Analysis.Test
{
    ...
    public class CfgBuildTests
    {
        ...
        class ExecNodeListener : NodeListener
        {
            ...
            {
				if (node != null && node.CodeElement != null && node.CodeElement.Type == Compiler.CodeElements.CodeElementType.ExecStatement)
					ExecSqlSeen = true;
            }
        };
        ...
        public void ExecSqlOutsideProc()
        {
            ...
            NodeListenerFactory ExecSqlDectector = () =>
            {
                listener = new ExecNodeListener();
                return listener;
            };

            NodeDispatcher.RegisterStaticNodeListenerFactory(ExecSqlDectector);
            ...
            NodeDispatcher.RemoveStaticNodeListenerFactory(ExecSqlDectector);
